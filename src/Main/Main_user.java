...
import form_user.data_anggota;
import form_user.data_barang;
import form_user.data_kredit;
import form_user.data_tunai;
...
public class Main_user extends javax.swing.JFrame {
    ...
    private void excute(){
        ...
        MenuItem menuUser= new MenuItem(iconUser,"Data Anggota",new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
            panelbody.removeAll();
            panelbody.repaint();
            ...
            panelbody.add(new data_anggota());
            panelbody.repaint();
            panelbody.revalidate();
            }
        });
        
        MenuItem menuBox= new MenuItem(iconBox,"Data Barang",new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
            panelbody.removeAll();
            panelbody.repaint();
        ...
        addMenu( menuUser,menuBox,menuPengajuan, menuPay);
    }
    ...
    private void initComponents() {
        ...
        laporan.setBackground(new java.awt.Color(102, 255, 204));
